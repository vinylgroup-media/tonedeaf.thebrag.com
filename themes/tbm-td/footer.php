...
<noscript id="deferred-styles">
    ...
    ?>
    <link rel="stylesheet" id="tbm-css" href="<?php echo CDN_URL; ?>css/style.css?v=20240503.1" type="text/css" media="all" />
...
<?php if (is_single()) {
    ...
    $imgSrc1 = isset($img_src1[0]) ? $img_src1[0] : '';
    $imgSrc2 = isset($img_src2[0]) ? $img_src2[0] : '';
    $imgSrc3 = isset($img_src3[0]) ? $img_src3[0] : '';

    array_push($post_featured_images, '"' . $imgSrc1 . '"', '"' . $imgSrc2 . '"', '"' . $imgSrc3 . '"');
