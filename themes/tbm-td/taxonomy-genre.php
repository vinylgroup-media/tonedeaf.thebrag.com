...
<?php
if (1 === $paged) {
    get_template_part('template-parts/genre/trending', null, array_merge($template_args, ['hero_stories' => $hero_stories]));
}
?>

<div class="container bg-yellow pt-1">
    <?php get_template_part('template-parts/genre/latest', null, array_merge($template_args, ['exclude_posts' => $exclude_posts])); ?>
</div>
