...
<html <?php language_attributes(); ?> class="no-js">
    <head>
        ...
        <link rel="mask-icon" href="/safari-pinned-tab.svg" color="#2982b3">
        <meta name="msapplication-TileColor" content="#2982b3">
...
.social-share-buttons a{-webkit-flex:1 1 auto;-ms-flex:1 1 auto;flex:1 1 auto;min-width:0;box-shadow:0;padding:10px;margin:5px 2px;float:left;border:0;text-decoration:none}
...
.quiz-section .quiz-details{width:100%;cursor:default;margin:10px auto;padding:0 10px 10px 0;box-sizing:border-box}
...
.quiz-story input.radio:empty{margin-left: -1000%}
...
.quiz-story input.radio:checked ~ label{background-color: #959595;}
...
.quiz-question{ display: flex;  margin-bottom: 20px; margin-top: 10px; line-height: 2rem; }
...
.results .result .result-text .title { font-size: 24px; font-family: 'Arvo', serif; }
...
@media only screen and (min-width:1201px) {
    .results { width: 100%; }
    .quiz-story input.radio:hover ~ label{background-color:#555;}
}
