...
<head>
  ...
  <?php if (is_single()) {
    ...
    <link rel="preconnect" href="<?php echo isset($src[0]) ? $src[0] : ''; ?>">
        ...
        if ($i < $number_of_menu_items):
          ...
          if ($i == $number_of_menu_items): ?>
            <li class="menu-more d-flex">
              <span class="arrow-down"><img src="<?php echo ICONS_URL; ?>icon_arrow-down-td.svg" width="10" height="9"
                  alt="▼"></span>
              <ul>
  ...
  <header class="fixed-top pb-1 py-md-0">
    ...
    <div class="d-flex d-md-none justify-content-between">
      <div class="d-flex">
        ...
        <div class="logo-wrap">
          <a href="<?php echo site_url(); ?>"><img src="<?php echo CDN_URL; ?>Tone-Deaf-light.svg" width="100"
              height="55" alt="Tone Deaf" title="Tone Deaf"></a>
        </div>
      </div>
            ...
            if (is_user_logged_in()):
              ...
              <button class="btn btn-primary btn-observer-top btn-toggle-slidedown d-flex" data-target="observer-list-top"
                ...
                <span class="">
                  ...
                  <img src="<?php echo ICONS_URL; ?>icon_mail-td.svg" class="btn-img hover" width="24" height="24"
                    alt="Mail">
                </span>
              </button>
              <a href="https://thebrag.com/profile/" target="_blank" rel="noreferrer"
                class="ml-1 user-name d-flex flex-row btn user text-white" style="padding: 0;">
    ...
    <div id="mobile-nav-wrap" class="nav-wrap container flex-column p-r" style="display: none;">
      <div id="search-nav-wrap" class="w-100 d-flex flex-column">
        <div id="top-search-wrap-mobile"
          ...
          <form role="search" method="get" id="searchform" class="searchform d-flex justify-content-center"
            ...
            <div style="flex: 1 1 auto;">
              <input type="text" name="s" class="search-field form-control" placeholder="Search..." autocomplete="off"
                aria-label="Search"
                style="padding: .35rem; border: none; border-radius: .5rem; margin-left: .25rem; background-color: transparent;">
            </div>
            <button type="submit" class="btn p-2" aria-label="Search"
        ...
        <div class="socials-top d-flex d-md-none justify-content-between" style="max-width: 320px; margin: 1rem auto;">
          <a href="https://www.facebook.com/tonedeafmusic" target="_blank" rel="noreferrer"><img
              src="<?php echo ICONS_URL; ?>facebook.svg" width="32" height="32" alt="Facebook" title="Facebook"></a>
          <a href="https://twitter.com/tonedeaf" target="_blank" rel="noreferrer"><img
              src="<?php echo ICONS_URL; ?>twitter.svg" width="32" height="32" alt="Twitter" title="Twitter"></a>
          <a href="https://www.instagram.com/tonedeaf/" target="_blank" rel="noreferrer"><img
              src="<?php echo ICONS_URL; ?>instagram.svg" width="32" height="32" alt="Instagram" title="Instagram"></a>
          <a href="https://www.youtube.com/c/tonedeaf" target="_blank" rel="noreferrer"><img
      ...
      <div class="my-2 btn btn-media-top btn-toggle-network-mobile d-flex" style="width: 100%;">
        <span class="brag-media-top"><img src="https://images-r2.thebrag.com/common/brands/202309/TBM_White.png" width="300"
            height="28" alt="The Brag Media" title="The Brag Media" style="width: 280px;" loading="lazy"></span>
        <span class="arrow-down ml-1"><img src="<?php echo ICONS_URL; ?>icon_arrow-down-td.svg" width="15" height="14"
            alt="▼"></span>
      </div>
    ...
    <div class="d-none d-md-block">
      <div class="d-flex justify-content-between container">
        <div class="network-socials-wrap d-none d-md-block">
          <div class="network-socials">
            <div class="btn btn-media-top btn-toggle-slidedown" data-target="network">
              <span class="brag-media-top"><img src="https://images-r2.thebrag.com/common/brands/202309/TBM_White.png"
                  width="130" height="13" alt="The Brag Media" title="The Brag Media" loading="lazy"></span>
              <span class="arrow-down"><img src="<?php echo ICONS_URL; ?>icon_arrow-down-td.svg" width="10" height="20"
                  alt="▼"></span>
            </div>
        ...
        <div class="d-flex">
          <div class="logo-wrap">
            <a href="<?php echo site_url(); ?>"><img src="<?php echo CDN_URL; ?>Tone-Deaf-light.svg" width="100"
                height="55" alt="Tone Deaf" title="Tone Deaf" loading="lazy"></a>
          </div>
        </div>
        <div class="user-wrap d-flex flex-column justify-content-end pr-1 pr-md-2 w-sm-auto">
          <div class="user-info d-none d-md-flex flex-row mb-1">
            ...
            if (is_user_logged_in()):
              ?>
              <a href="https://thebrag.com/profile/" target="_blank" rel="noreferrer"
                class="user-name d-flex flex-row btn user text-white" style="padding: 0;">
                <?php echo get_avatar($current_user, 24, 'mystery', $user_info->first_name, ['class' => 'rounded-circle']); ?>
              </a>
            <?php else: ?>
      ...
      <div class="nav-wrap container d-md-flex flex-column flex-md-row p-r">
        <div id="top-search-wrap"
          ...
          <form role="search" method="get" id="searchform" class="searchform d-flex justify-content-center"
            ...
            <div style="flex: 1 1 auto;">
              <input type="text" name="s" class="search-field form-control" placeholder="Search..." autocomplete="off"
                aria-label="Search" style="padding: .35rem; border: none; border-radius: .5rem; margin-left: .25rem;">
            </div>
            <button type="submit" class="btn p-2" aria-label="Search"
