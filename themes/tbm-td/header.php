    ...
    if (is_single()) :
        if (get_field('page_background_colour')) : ?>
            <style>
                body {
                    background-color:
                        <?php echo get_field('page_background_colour'); ?> !important;
                }
            </style>
    <?php endif;
    ...
    <header class="fixed-top pb-1 py-md-0">
        ...
        <div id="mobile-nav-wrap" class="nav-wrap container flex-column p-r" style="display: none;">
            ...
            <div class="my-2 btn btn-media-top btn-toggle-network-mobile d-flex" style="width: 100%;">
                <span class="brag-media-top"><img src="https://images-r2.thebrag.com/common/brands/202309/TBM_White.png" width="300" height="28" alt="The Brag Media" title="The Brag Media" style="width: 180px;" loading="lazy"></span>
                ...
                <div class="network-socials-wrap d-none d-md-block">
                    <div class="network-socials">
                        <div class="btn btn-media-top btn-toggle-slidedown" data-target="network">
                            <span class="brag-media-top"><img src="https://images-r2.thebrag.com/common/brands/202309/TBM_White.png" width="130" height="13" alt="The Brag Media" title="The Brag Media" loading="lazy" style="width: 105px;"></span>
