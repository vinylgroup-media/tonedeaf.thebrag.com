  ...
  ?>
    <div class="d-flex flex-row flex-wrap justify-content-start topics <?php echo is_user_logged_in() ? 'topics-active' : ''; ?>">
      <?php foreach ($lists as $index => $list) : ?>
        <a href="http://thebrag.com/wp-login.php?redirect_to=<?php echo urlencode($list->link); ?>" class="d-flex <?php echo isset($list->subscribed) && $list->subscribed ? 'subscribed' : ''; ?>" target="_blank" data-list="<?php echo $list->id; ?>" rel="noreferrer">
