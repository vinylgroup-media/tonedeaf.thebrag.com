...
if (!post_password_required($post)) :
    ...
    ?>
    <article class="<?php echo $is_native ? 'kwords-exclude ' : ''; ?>single-article featured p-2 p-md-3 pb-1 single-article-<?php echo $count_articles === 1 ? '1' : 'infinite'; ?>" id="<?php the_ID(); ?>">
