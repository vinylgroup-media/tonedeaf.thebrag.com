            ...
            <div class="read-article-wrap pt-2 w-100">
                <div class="d-flex justify-content-between">
                    ...
                    if (get_field('author', $story_ID) || get_field('Author', $story_ID)) :
                        ...
                        $author_img_src = get_field('author_profile_picture', $story_ID) ? wp_get_attachment_image_src(get_field('author_profile_picture', $story_ID), 'thumbnail') : CDN_URL . '/images/default-avatar.png';
                        ...
                        <div class="d-flex">
                            <div class="author-avatar mr-1">
                                ...
                                if (isset($author_img_src)) {
                                    ...
                                    echo get_avatar($story->post_author, 24, CDN_URL . '/images/default-avatar.png', '', array('class' => 'rounded'));
                                }
                                ?>
                            </div>
