            ...
            <div class="read-article-wrap pt-2 w-100">
                <div class="d-flex justify-content-between">
                    ...
                    if (get_field('author', $trending_story_ID) || get_field('Author', $trending_story_ID)) :
                        ...
                        $author_img_src = get_field('author_profile_picture', $storytrending_story->ID_ID) ? wp_get_attachment_image_src(get_field('author_profile_picture', $trending_story->ID), 'thumbnail') : IMAGES_R2_CDN_URL . 'td/3/default-avatar.png';
                        ...
                        <div class="d-flex">
                            <div class="author-avatar mr-1">
                                ...
                                if (isset($author_img_src)) {
                                    ...
                                    echo get_avatar($trending_story->post_author, 24, IMAGES_R2_CDN_URL . 'td/3/default-avatar.png', '', array('class' => 'rounded'));
                                }
                                ?>
                            </div>
