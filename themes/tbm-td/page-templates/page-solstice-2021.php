        ...
        ?>
                ...
                <div class="news_story">
                    <?php if ('' !== get_the_post_thumbnail()) : ?>
                        ...
                        ?>
                    <?php endif; ?>
                    <div class="post-content-solstice">
                        <div class="jumbotron" style="background-color: rgba(255,255,255,.5);">
                            <div class="row">
                                <div class="col-md-5 mb-3 pr-0 pr-md-2">
                                ...
                                <div class="col-md-7 mb-3 pl-0 pl-md-2">
                                    <div class="p-2 p-md-0">
                                        <h1 style="font-size: 2rem; color: #14297d; line-height: 1;">Tone Deaf celebrates Sydney Solstice with a 12 day festival of music</h1>
